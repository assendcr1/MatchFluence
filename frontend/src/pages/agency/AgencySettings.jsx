  ...
  return (
    <div className="p-7 page-fade max-w-lg">
      ...
      <div className="card p-6 space-y-4">
        <div><label className="label">Agency</label><p style={{color:'#ccc'}}>{session.name}</p></div>
        <div><label className="label">User Type</label><span className="badge-purple">Agency</span></div>
